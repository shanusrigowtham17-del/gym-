...
// =============================================
// 2. ABOUT SECTION — 3D ROTATING OCTAHEDRON
// =============================================
(function initCubeCanvas() {
  ...
  const ring2 = new THREE.Mesh(ringGeo, new THREE.MeshBasicMaterial({ color: 0xff4d00, transparent: true, opacity: 0.3 }));
  ring2.rotation.x = Math.PI / 2;
  const ring3 = new THREE.Mesh(ringGeo, new THREE.MeshBasicMaterial({ color: 0xff4d00, transparent: true, opacity: 0.2 }));
...
// =============================================
// 3. JOIN SECTION — PARTICLE NETWORK
// =============================================
